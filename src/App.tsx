...
const projects: Project[] = [
  ...
  { number:'04', title:'Data Analytics & Reporting', category:'Data & reporting', description:'Academic SQL results, a PostgreSQL workspace, Excel reporting, and database modelling across baseball, aviation, and activity datasets.', tags:['SQL','PostgreSQL','DataGrip','Excel'], icon:Network, caseStudy:'#support' },
  ...
  { number:'07', title:'Graphic Design & Visual Identity', category:'Visual communication', description:'Brand identities, advertising, notebook cover design, and campaign graphics.', tags:['Brand identity','Layout','Typography'], icon:Sparkles, caseStudy:'#graphic-design' },
  { number:'08', title:'Data Detective Research Presentation', category:'Presentation design', description:'An academic slide deck showcasing visual hierarchy, chart layouts, and research communication.', tags:['Presentation design','Visual storytelling'], icon:Sparkles, caseStudy:'#presentation-design' },
  { number:'09', title:'Kumasi YSA Quick Start Guide', category:'Technical writing', description:'An audience-focused guide turning community orientation into clear first-week actions, routines, and a practical checklist.', tags:['Technical writing','Documentation','Onboarding'], icon:GraduationCap, caseStudy:'#technical-writing' },
  { number:'10', title:'Communication Development Plan', category:'Professional development', description:'A structured practice-and-reflection plan covering active listening, clear communication, emotional awareness, and conflict resolution.', tags:['Active listening','Goal setting','Reflection'], icon:Check, caseStudy:'#communication-development' },
];
  ...
  return <div className="site-shell">
    ...
    <main id="top">
      ...
      <section className="education-section section-wrap academic-redesign" id="academics"><div className="section-label"><span>05</span><span>Academic profile</span></div><div className="academic-hero"><div><p className="academic-kicker">Education · Credentials · Transcript</p><h2>Study with <em>purpose.</em></h2><p>My academic record brings together my primary IT discipline, engineering foundation, professional certificates, and the semester results behind them.</p></div><div className="academic-gpa-card"><span>Primary discipline</span><strong>4.0 / 4.0</strong><b>Ensign College GPA</b><small>Bachelor of Applied Science in System Administration · Final Year</small></div></div>
        ...
        <div className="professional-credentials"><div className="academic-heading"><span>05</span><div><h3>Professional credentials</h3><p>Selected academic, technical, and language credentials with direct access to the supporting documents.</p></div></div>
        ...
        <div className="professional-credentials" id="professional-development" style={{scrollMarginTop: '100px'}}>
<div className="academic-heading"><span>06</span><div><h3>Professional development</h3><p>20 completed LinkedIn Learning courses across data analytics, Power BI, Tableau, technical writing, business communication, and AI-assisted research.</p></div></div>
...
<a href="./certificates/emotional-intelligence.pdf" target="_blank" rel="noopener noreferrer"><Award size={17}/><span><strong>Communicating with Emotional Intelligence</strong><small>LinkedIn Learning · Completed 31 July 2026 · View PDF</small></span><ArrowUpRight size={16}/></a></div><h3>AI research and writing</h3><div className="document-links"><a href="./certificates/ai-research-writing.pdf" target="_blank" rel="noopener noreferrer"><Award size={17}/><span><strong>How to Research and Write Using Generative AI Tools (2023)</strong><small>LinkedIn Learning · Completed 31 July 2026 · View PDF</small></span><ArrowUpRight size={16}/></a></div>
</div>
