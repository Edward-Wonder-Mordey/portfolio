...
<div className="academic-heading"><span>06</span><div><h3>Data analytics professional development</h3><p>10 completed LinkedIn Learning courses supporting my SQL, reporting, and Power BI skills.</p></div></div>
...
<h3>SQL and analytics foundations</h3><div className="document-links"><a href="./certificates/sql-reporting.pdf" target="_blank" rel="noopener noreferrer"><Award size={17}/><span><strong>SQL: Data Reporting and Analysis</strong><small>LinkedIn Learning · Completed 15 July 2026 · View PDF</small></span><ArrowUpRight size={16}/></a>
