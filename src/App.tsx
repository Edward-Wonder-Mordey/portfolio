...
const experience = [
  ...
  { year:'2025', role:'Auditor · Data Analyst Specialist', company:'Springboard · Remote', detail:'Cleaned and validated family-tree datasets, conducted participant-data and compliance audits, and supported reporting accuracy. Onboarding included Clockify time-tracking training.' },
